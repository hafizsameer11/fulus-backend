...
const BILL_SERVICES: Array<{
  ...
  { id: "ibedc", category: "ELECTRICITY", name: "Ibadan Electric", shortName: "IBEDC", logoKey: "ibedc", providerCode: "ibadan-electric", accent: "#1565C0" },
  { id: "phed", category: "ELECTRICITY", name: "Port Harcourt Electric", shortName: "PHED", logoKey: "phed", providerCode: "portharcourt-electric", accent: "#C62828" },
  { id: "kedco", category: "ELECTRICITY", name: "Kano Electric", shortName: "KEDCO", logoKey: "kedco", providerCode: "kano-electric", accent: "#2E7D32" },
  { id: "kaedco", category: "ELECTRICITY", name: "Kaduna Electric", shortName: "KAEDCO", logoKey: "kaedco", providerCode: "kaduna-electric", accent: "#6A1B9A" },
  { id: "jed", category: "ELECTRICITY", name: "Jos Electric", shortName: "JED", logoKey: "jed", providerCode: "jos-electric", accent: "#EF6C00" },
  { id: "eedc", category: "ELECTRICITY", name: "Enugu Electric", shortName: "EEDC", logoKey: "eedc", providerCode: "enugu-electric", accent: "#00838F" },
  { id: "bedc", category: "ELECTRICITY", name: "Benin Electric", shortName: "BEDC", logoKey: "bedc", providerCode: "benin-electric", accent: "#AD1457" },
  { id: "aba", category: "ELECTRICITY", name: "Aba Electric", shortName: "ABA", logoKey: "aba", providerCode: "aba-electric", accent: "#455A64" },
  { id: "yedc", category: "ELECTRICITY", name: "Yola Electric", shortName: "YEDC", logoKey: "yedc", providerCode: "yola-electric", accent: "#558B2F" },
  {
    id: "dstv",
    category: "CABLE",
    name: "DStv",
